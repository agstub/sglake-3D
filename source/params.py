...
parser.add_argument('-C', type=float, default=5.0e9, metavar='drag_coeff',
...
quad_degree = 12                   # quadrature degree for weak forms

tol = 1.0e-1                       # numerical tolerance for boundary geometry:
...
nx = 100*Nx                          # number of grid points for interpolating
...
Y_fine = np.linspace(0,Lngth,nx)   # horizontal coordinate for computing surface
